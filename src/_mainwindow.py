...
class mainWithTabs(QMainWindow):
    ...
    def configurationFairPrice(self):
        ...
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.doubleSpinBox_manualUSinterest.setDisabled(True)
        )
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.pushButton_manualDIGO.setDisabled(True)
        )
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.lcdNumber_RTDdi.setEnabled(True)
        )
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.doubleSpinBox_RTDusInterest.setEnabled(True)
        )
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.pushButton_RTDdiGO.setEnabled(True)
        )
        self.ui.radioButtonRTDdi.toggled.connect(
            lambda: self.ui.comboBoxRTDdi.setEnabled(True)
        )

        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.doubleSpinBox_manualDI.setEnabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.doubleSpinBox_manualUSinterest.setEnabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.pushButton_manualDIGO.setEnabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.lcdNumber_RTDdi.setDisabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.doubleSpinBox_RTDusInterest.setDisabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.pushButton_RTDdiGO.setDisabled(True)
        )
        self.ui.radioButton_ManualDI.toggled.connect(
            lambda: self.ui.comboBoxRTDdi.setDisabled(True)
        )
        ...
        self.ui.radioButton_RtdCurve.toggled.connect(
            lambda: self.ui.doubleSpinBox_ManualPTAX.setDisabled(True)
        )
        self.ui.radioButton_RtdCurve.toggled.connect(
            lambda: self.ui.pushButton_ManualCurveGO.setDisabled(True)
        )
        self.ui.radioButton_RtdCurve.toggled.connect(
            lambda: self.ui.comboBox_FRC.setEnabled(True)
        )
        self.ui.radioButton_RtdCurve.toggled.connect(
            lambda: self.ui.comboBox_RtdPTAX.setEnabled(True)
        )
        self.ui.radioButton_RtdCurve.toggled.connect(
            lambda: self.ui.pushButton_RTDcurveGO.setEnabled(True)
        )

        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.doubleSpinBox_ManualFRC.setEnabled(True)
        )
        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.doubleSpinBox_ManualPTAX.setEnabled(True)
        )
        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.pushButton_ManualCurveGO.setEnabled(True)
        )
        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.comboBox_FRC.setDisabled(True)
        )
        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.comboBox_RtdPTAX.setDisabled(True)
        )
        self.ui.radioButton_ManualCurve.toggled.connect(
            lambda: self.ui.pushButton_RTDcurveGO.setDisabled(True)
        )
    ...
    def userProfile(self):
        ...
        self.ui.comboBox_nome.activated.connect(lambda: self.mudaDadosUsuario())
    ...
    def irTabSheet(self):
        ...
        self.ui.pushButton_BrowseFile.clicked.connect(lambda: self.fileBrowser())
